...
contract Ticket is ERC721Full{
    ...
    function getTicketMetadata( uint256 ticketTokenId ) public view returns(uint256 id, string memory name,string memory location,string memory artist,string memory price,string memory seat,string memory date,string memory ipfs_hash){
    ...
    function mint(string memory _name, string memory _location, string memory _artist, string memory _price, string memory _seat, string memory _date, string memory _ipfs_hash) public returns (uint256 ticketTokenId){
       ...
       TicketMetadata memory _metadata = TicketMetadata({id: ticketTokenId, name: _name, location: _location, artist: _artist, price: _price, seat: _seat, date: _date, ipfs_hash: _ipfs_hash});
